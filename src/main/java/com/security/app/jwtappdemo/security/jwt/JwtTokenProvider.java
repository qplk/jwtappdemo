...
public class JwtTokenProvider {
    ...
    public String createToken(String username, List<Role> listRoles) {
    ...
    public List<String> getRoleNames(List<Role> listRoles) {
        return listRoles.stream().map(Role::getName)
